...
export default function Home(props) {
  ...
  useEffect(() => {
    const getTotalAmt = async () => {
      try {
        let fundraiserStore = new web3.eth.Contract(
          contractABI,
          contractAddress
        );
    ...
    <>
      <div className="main">
        <div className="container ">
          <p>
            <h4>
              <b>Total Fund Raised={totalAmt} WEI</b>
            </h4>
          </p>
        ...
        <div className="container btn-home">
          <button className="btn btn-success" style={{}}>
            ...
            >
              ...
              <img
                src={donate}
                style={{ width: "30px", margin: "4px", height: "30px" }}
              ></img>{" "}
              Want to Donate ?
            </Link>{" "}
          </button>
          ...
          <button className="btn btn-success">
            <Link to={`/aboutus`} style={{ color: "white", display: "flex" ,alignItems: "center"}}>
              ...
              <img
                src={info}
                style={{ width: "30px", marginRight: "4px", height: "30px" }}
              ></img>
              About us
            </Link>{" "}
          </button>
